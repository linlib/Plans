...
\newpage
\begin{center}
\scalebox{1.3}{{\bf Stage I: Three Whitehead Theorems and Three Puppe Sequences (2024)}}
\end{center}
...
\newpage
\begin{center}
\scalebox{1.3}{{\bf Stage II: Three Freudenthal Suspension Theorems and Three Long Exact Sequences (2025)}}
\end{center}
...
\newpage
\begin{center}
\scalebox{1.3}{{\bf Stage III: Geometric Maps in Higher Topos Theory (2026)}}
\end{center}
...
\newpage
\begin{center}
\scalebox{1.3}{{\bf Stage IV: Geometric Maps in Stable Homotopy Theory (2027)}}
\end{center}
...
\newpage
\begin{center}
\scalebox{1.3}{{\bf Stage V: Number Theory}}
\end{center}
...
\item ℤ̂ splits as a product Π ℤₚ
\end{enumerate}
...
The tangent and cotangent bundles of a manifold are typically constructed using derivations. The analogue for a vector bundle on a manifold entails the use of flat connections instead.\\
...
\item Ext¹ is of central interest in Poincare duality.
\item Ext¹ and Haar integral on profinite groups
\item A compact-hausdorff space is a quotient of a 
\end{enumerate}
